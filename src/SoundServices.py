...
#        self.strtSources[ 0 ] = openal.oalOpen("RepTimerClip.wav")
#        self.strtSources[ 1 ] = openal.oalOpen("RepTimerClip2.wav")
        for cnt in range( len( self.strtSources ) ) :
            self.strtSources[ cnt ] = pygame.mixer.Sound("RepTimerClip.wav")
