...
"            } \n" +
    ...
    def display_gl(self, modelview, projection):
        ...
        if not igInitialized :
            ...
            SHOULDER_PRESS_MODE = 1
            
            BICEP_CURL_MODE = 2
            
            rMode = SHOULDER_PRESS_MODE
            
            
            totalRepTime = self.elapsedTime % 4.0
            
            
                    
            for tobj in self.scene.idealWeightsA :
